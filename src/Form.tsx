  ...
  return (
    ...
    >
      <div className="flex flex-col ">
        <label htmlFor="title" className="mb-1 text-blue-600">
          Title:
        </label>
        <input
          type="text"
          ...
          className="px-3 py-2 border border-blue-400 rounded-md"
        />
      </div>

      <div className="flex flex-col">
        <label htmlFor="description" className="mb-1 text-blue-600">
          Description:
        </label>
        <textarea
          id="description"
      ...
      <div className="flex flex-col">
        <label htmlFor="dueDate" className="mb-1 text-blue-600">
          Due Date:
        </label>
        <input
          type="date"
      ...
      <div className="flex flex-col">
        <label htmlFor="priority" className="mb-1 text-blue-600">
          Priority:
        </label>
        <select
          id="priority"
